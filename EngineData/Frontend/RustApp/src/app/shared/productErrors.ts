...
const FRIENDLY_MESSAGES: Record<string, string> = {
  ...
  package_replace_older_version: "This package is older than the version already installed.",
  package_replace_version_invalid: "SearchNow could not compare this package version safely.",
  package_replace_installed_version_missing: "The installed pack version is unavailable, so automatic update is disabled.",
