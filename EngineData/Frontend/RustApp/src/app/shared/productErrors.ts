...
const FRIENDLY_MESSAGES: Record<string, string> = {
  ...
  diagnostics_report_serialize_failed: "SearchNow could not prepare the diagnostics report.",
  diagnostics_report_destination_invalid: "The selected diagnostics report destination is not valid.",
  diagnostics_report_write_failed: "SearchNow could not write the diagnostics report to the selected location.",
  ...
  library_export_verification_failed: "SearchNow could not verify the completed backup safely. The unverified output was removed.",
  library_export_verification_cleanup_failed: "SearchNow could not verify the backup and could not remove the unverified output. Review the export folder.",
  library_batch_export_rollback_failed: "Batch export failed and SearchNow could not remove every newly created backup. Review the export folder.",
  ...
  package_bundle_replace_not_supported: "This add-on bundle is not eligible for automatic transactional update.",
  package_bundle_replace_uuid_missing: "Every pack in this add-on needs a manifest UUID before SearchNow can update it safely.",
  package_bundle_replace_uuid_duplicate: "This add-on contains duplicate pack UUIDs and cannot be updated automatically.",
  package_bundle_replace_kind_unsupported: "This add-on contains a pack type that is not supported by automatic update.",
  package_bundle_replace_version_invalid: "SearchNow could not compare every pack version in this add-on safely.",
  package_bundle_replace_target_ambiguous: "More than one installed pack matches this add-on, so SearchNow will not update automatically.",
  package_bundle_replace_type_mismatch: "An installed pack type does not match its incoming add-on pack.",
  package_bundle_replace_installed_version_missing: "An installed pack has no comparable version, so this add-on cannot be updated automatically.",
  package_bundle_replace_older_version: "At least one pack in this add-on is older than the installed version.",
  package_bundle_replace_same_version: "This add-on does not contain a newer or missing pack to apply.",
  package_bundle_replace_path_rejected: "SearchNow refused to update this add-on because an installed pack location is not safe.",
  package_bundle_dependency_missing: "This add-on requires a pack dependency that is neither installed nor included in the bundle.",
  package_bundle_dependency_outdated: "This add-on would leave a required pack dependency below the required version.",
  package_bundle_replace_destination_exhausted: "SearchNow could not allocate a safe destination folder for a new pack in this add-on.",
  package_bundle_replace_plan_invalid: "The add-on update plan is no longer valid and was not applied.",
  package_bundle_replace_existing_unavailable: "An installed pack changed or disappeared before the add-on update could be applied.",
  package_bundle_replace_existing_invalid: "An installed pack path is no longer safe to update.",
  package_bundle_replace_staging_failed: "SearchNow could not prepare the add-on update safely.",
